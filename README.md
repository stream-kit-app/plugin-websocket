# WebSocket plugin distribution

This repository publishes the official **Stream Kit** distribution for the **WebSocket** plugin (`websocket`).
...
1. Download `plugin-websocket.zip` from the [latest release](https://github.com/stream-kit-app/plugin-websocket/releases/latest).
